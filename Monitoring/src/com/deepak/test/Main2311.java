    ...
    public void run() {
        ...
        try {
            ...
            while ((sCurrentLine = br.readLine()) != null) {
                ...
                if (sCurrentLine.contains("172.16.23.11")) {
            ...
            System.out.println("172.16.23.11");
            // System.out.println("\n CPU\n");
            for (int i = 0; i < 5; ++i)
            ...
            String freeSpace = sCurrentLine.substring(sCurrentLine.indexOf("alog") + 5, sCurrentLine.indexOf("MB")) + " MB/"
